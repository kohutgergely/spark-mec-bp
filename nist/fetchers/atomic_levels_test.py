import pytest
from nist.fetchers.atomic_levels import AtomicLevelsFetcher
...
def test_fetch_get_request_is_called_with_valid_parameters(
    ...
    mock_get = mocker.patch("nist.atomic_levels.requests.get")
...
def test_fetch_calls_response_validator_which_returns_false_and_raises_exception(
    ...
    mock_validator = mocker.patch(
        "nist_sdk.atomic_levels.ResponseErrorValidator")
